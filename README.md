...
This repository houses an R Shiny Dashboard app that allows for interactive exploration of metrics and spatial data. It follows the [golem](https://github.com/ThinkR-open/golem/tree/master) framework for Shiny app development. 
