...
# System dependencies
RUN apt-get update && \
    apt-get install -y chromium cmake gdal-bin git libabsl-dev libcurl4-openssl-dev libgdal-dev libgeos-dev libicu-dev libpng-dev libproj-dev libsqlite3-dev libssl-dev libudunits2-dev libuv1-dev libxml2-dev make pandoc xz-utils zlib1g-dev && \
